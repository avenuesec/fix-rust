...
pub struct AllocationFields {
    ...
    pub no_orders : Option<Vec<NoOrders15Fields>>, // FIELD_NOORDERS 0
...
pub struct MarketDataRequestFields {
    ...
    pub no_related_sym : Vec<NoRelatedSym26Fields>, // FIELD_NORELATEDSYM 0
...
pub struct NoQuoteSets21Fields {
    ...
    pub no_quote_entries : Option<Vec<NoQuoteEntries20Fields>>, // FIELD_NOQUOTEENTRIES 0
  ...
  while let Some(fld) = consumer.next() { 
    match fld {
      ...
      &FieldVal { id: FIELD_NOQUOTEENTRIES, val: v } => { 
        ...
        // group
          let size = usize::from_str(v).unwrap();
          let subgroup = build_group_no_quote_entries19_fields(consumer, size);
